...
benchmark() {
    ...
    echo -n "100;1000;100;" >> single_process_results.csv && ./bin/single_process_benchmark -r 1 -c 1 -w 32 -x 1 -y 1 -m 100 -k 1000 -n 100 | sed 's/\s\+/;/' >> single_process_results.csv

    echo "100x10000 10000x100"
    echo -n "100;10000;100;" >> single_process_results.csv && ./bin/single_process_benchmark -r 1 -c 1 -w 32 -x 1 -y 1 -m 100 -k 10000 -n 100 | sed 's/\s\+/;/' >> single_process_results.csv
