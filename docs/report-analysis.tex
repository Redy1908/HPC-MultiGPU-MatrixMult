...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a1.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a1_speedup.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a1_efficiency.png}
    \caption{Caso 1a}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a2.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a2_speedup.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_a2_efficiency.png}
    \caption{Caso 1b}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_b.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_b_scaled_speedup.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_b_scaled_efficiency.png}
    \caption{Caso 2}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_c.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_c_scaled_speedup.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_c_scaled_efficiency.png}
    \caption{Caso 3}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_d.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_d_scaled_speedup.png}
    \includegraphics[width=0.7\textwidth]{./imgs/plots/caso_d_scaled_efficiency.png}
    \caption{Caso 4}
\end{figure}
